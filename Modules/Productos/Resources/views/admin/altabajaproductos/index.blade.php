                ...
                <div class="box-header">
                    ...
                    {!! Form::open(array('route' => ['admin.productos.altabajaproducto.indexAjax'],'method' => 'post', 'id' => 'search-form')) !!}
                        ...
                        <table>              
                            ...
                            <input type="text" class="form-control input-sm" name="fecha_inicio" id="fecha_inicio" value="{{ \Carbon::now()->startOfMonth()->format('d/m/Y') }}" style=""></td>
                        ...
                        <table>              
                            <tr>
                                ...
                                <input type="text" class="form-control input-sm" name="fecha_fin" id="fecha_fin" value="{{ \Carbon::now()->format("d/m/Y") }}" style=""></td>
