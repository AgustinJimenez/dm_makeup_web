...
$router->group(['prefix' =>'/productos'], function (Router $router) {
    ...
    $router->get('productos/historial/{producto}', [
        'as' => 'admin.productos.producto.historial',
        'uses' => 'ProductoController@historial',
        'middleware' => 'can:productos.productos.historial'
    ]);
