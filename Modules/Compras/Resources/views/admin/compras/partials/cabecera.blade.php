        ...
        <!-- Modal content-->
          <div class="modal-content">
            ...
            <div class="row">
              <div class="col-md-4">
                @if($isOtro)
                  {!! Form::normalSelect('tipo_comprobante', 'Comprobante:', $errors, $tipos_comprobantes_sin_factura, isset($compra)?$compra:null) !!}
                @else
                  {!! Form::normalSelect('tipo_comprobante', 'Comprobante:', $errors, $tipos_comprobantes, isset($compra)?$compra:null) !!}
                @endif

              </div>
                <div class="col-md-4">
                    {!! Form::normalInput('nro_factura', 'Nro de Comprobante:', $errors, isset($compra)?$compra:null,["autofocus"]) !!}
                </div>
                <div class="col-md-4">
                ...
                {!! Form::normalInput('total_pagado', 'Total Pagado', $errors, isset($compra)?$compra:'0') !!}

                {!! Form::normalInput('vuelto_cliente', 'Vuelto:', $errors, null, ['readonly' => '']) !!}


                {!! Form::normalSelect('tipo_factura', 'Condición de comrpa:', $errors, ['contado'=>'Contado','credito'=>'Credito'], isset($compra)?$compra:null) !!}
...
<!--*************************************************Modal_Pago*****************************************************************************************-->
@include("compras::admin.compras.partials.modal-alert")
