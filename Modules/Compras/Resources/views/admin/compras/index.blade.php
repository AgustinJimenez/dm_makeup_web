            ...
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    {!! Form::open(array('route' => ['admin.compras.compra.index_ajax'],'method' => 'post', 'id' => 'search-form')) !!}
                        <div class="col-md-2">
                            <label for="nro_factura" class="control-label" >Nro de Comprobante:   </label>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                              ...
                              <tr>
                                  <td>
                                      {!! Form::normalInput('fecha_inicio', 'Fecha Inicio:', $errors, (object)["fecha_inicio" => $desde], ['placeholder' => 'Fecha Inicio'] ) !!}
                                  </td>
                                  <td>
                            ...
                            <div class="col-md-2">
                              ...
                              <tr>
                                  <td>
                                      {!! Form::normalInput('fecha_fin', 'Fecha Fin:', $errors, (object)["fecha_fin" => $hoy], ['placeholder' => 'Fecha Fin'] ) !!}
                                  </td>
                                  <td>
