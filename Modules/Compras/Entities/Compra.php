...
class Compra extends Model
{
    ...
    public static function getTiposComporbantes(){
      return [
              "Factura" => "Factura",
              "Recibo" => "Recibo",
    ...
    public static function getTiposComporbantesSinFactura(){
      return [
              "Recibo" => "Recibo",
              "Autofactura" => "Autofactura",
              "Sin comprobante" => "Sin comprobante"];
    ...
    //  public function gravados_compra()
    // {
    //     $total_iva_10 = 0;
    ...
    public function getSumaTotalPagosFormatAttribute()
   {
    ...
    public function getTotalGravadoIvaAttribute()
    {
        $number = $this->gravado_excenta + $this->gravado_5 + $this->gravado_10 + $this->total_iva_10 + $this->total_iva_5;
        return $number;
        return number_format($number, 0, '', '.');
    }
