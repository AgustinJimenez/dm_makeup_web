            ...
            <table cellpadding="2" style="width: 100%;">
                ...
                <tbody>
                        ...
                        <tr valign="bottom">
                            ...
                            <td bgcolor="#ffffff" >
                                <p align="center"><span style="color: #000000;">{{ number_format($libro_venta->gravado_excenta, 0, '', '.') }}</span></p>
                            </td>
                            
                            <td bgcolor="#ffffff" >
                                <p align="center"><span style="color: #000000;" >{{ number_format($libro_venta->gravado_5, 0, '', '.') }}</span></p>
                            </td>
                            
                            <td bgcolor="#ffffff" >
                                <p align="center"><span style="color: #000000;" >{{ number_format($libro_venta->gravado_10, 0, '', '.') }}</span></p>
                            </td>
                            ...
                            <td bgcolor="#ffffff" >
                                <p align="center"><span style="color: #000000;" >{{ number_format($libro_venta->total_gravado, 0, '', '.') }}</span></p>
                            </td>
                        </tr>
				...
				<tbody>
						@foreach ($libro_compras as $libro_compra)
								...
								<tr valign="bottom">
									...
									<td bgcolor="#ffffff" >
										<p align="center"><span style="color: #000000;">{{ number_format($libro_compra->gravado_excenta, 0, '', '.') }}</span></p>
									</td>	
								
									<td bgcolor="#ffffff" >
										<p align="center"><span style="color: #000000;" >{{ number_format($libro_compra->gravado_5, 0, '', '.') }}</span></p>
									</td>
							
									<td bgcolor="#ffffff" >
										<p align="center"><span style="color: #000000;" >{{ number_format($libro_compra->gravado_10, 0, '', '.') }}</span></p>
									</td>
									...
									<td bgcolor="#ffffff" >
										<p align="center"><span style="color: #000000;" >{{ number_format($libro_compra->total_gravado_iva, 0, '', '.') }}</span></p>
									</td>					
