	...
	public function run()
	{
		...
		try
		{
			for ($i=0; $i < 1000; $i++)
			{
				...
				$total_iva_10 = 0; $total_iva_5 = 0; $gravado_excenta = 0; $total_item_con_iva_10 = 0; $total_item_con_iva_5 = 0; $gravado_5 = 0; $gravado_10 = 0;
		        ...
		        for ($i=0; $i < count($detalles) ; $i++)
		        {
		            ...
		            {
		                $gravado_excenta += intval($precio_unitario*$cantidad);
		            }
		        }
