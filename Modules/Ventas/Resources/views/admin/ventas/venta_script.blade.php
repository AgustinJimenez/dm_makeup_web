           ...
           $("#generar_factura").click(function(event)
           {
            ...
            $(".submit_button").click(function(e)
            {
               ...
               //console.log( 'cliente_id es ['+cliente_id+'] ' );
                ...
                {
                    var producto_id = $(this).closest('td').closest('tr').find('input[id=producto_id]').val() || null;

                    var servicio_id = $(this).closest('td').closest('tr').find('input[id=servicio_id]').val() || null;
            ...
            {
            @if( \Config::$preventa )
                var total_preventa = $('#total_pagar').val().replace(/\./g,'');
                ...
                if (total_preventa > 0)
                {
                    if(!total_pago_preventa)
                        total_pago_preventa = "0";
           ...
           //console.log('x ready: '+x);
            ...
            $('#agregar').click(function (e)
            {
               ...
               //console.log('agregar clicked, '+'x is: '+x);
                ...
                '<tr id="'+x+'">'+column_tipo+''+column_seleccion+column_cantidad+''+column_iva+''+column_precioUnitario+''+column_precio+''+column_subtotalMasIva+''+column_accion+'</tr>');
