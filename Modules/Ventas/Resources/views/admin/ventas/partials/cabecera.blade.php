 <style type="text/css">
    ...
    @if(!$isOtros && $hay_preventa)<!--SOLO MUESTRA NUMERO DE SOBRE CUANDO LA VENTA NO ES (OTRAS VENTAS)-->
    ...
    @endif
        ...
        <div class="col-md-2 text-center" @if(isset($isPreventa) and $isPreventa) style="display:none;"@endif>
            {!! Form::normalInput('fecha_venta', 'Fecha de Ventas', $errors, isset($venta)?$venta:(object)['fecha_venta' => $fecha], ['required' => '' , 'class'=> 'form-control text-center'] ) !!}
        </div>
        ...
        <div class="col-md-3 text-center">
            {!! Form::normalSelect("visita_id", "Visita", $errors, $visitas_list, isset($venta)?$venta:null ) !!}
        </div>
<br>
