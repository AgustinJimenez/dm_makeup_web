...
<style type="text/css">
    ...
    hr
    {
        ...
        <div class="row">
            @if($facturaventa->venta->nro_seguimiento && $hay_preventa)
            <div class="col-md-2">
            ...
            @if($facturaventa->venta->visita)
            <div class="col-md-2 text-center">
                {!! Form::label('visita', 'Visita:') !!}
                {{ $facturaventa->venta->visita->lugar }}
            </div>
            @endif
        </div>
        @if($facturaventa->venta->nro_seguimiento && $hay_preventa)
        ...
        <tr>
            ...
            <td >
                ...
                {{-- @if ($venta->descuento_total > 0)
                  <p class="help-block">* El descuento ya se aplicó al precio de venta</p>
                @endif --}}
            </td>
        </tr>
        <tr>
                    ...
                    @if(isset($facturaventa->venta)?!$facturaventa->venta->anulado:null)
                        ...
                        <div class="col-md-3">
                            @if(!$facturaventa->anulado)
                                {!! Form::button('Confirmar', array('class' => 'btn btn-primary btn-flat', 'id' => 'actualizar_button')) !!}
                        </div>
                    @endif
                </div>
</div>
